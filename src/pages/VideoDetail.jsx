...
function VideoDetail() {
  ...
  // Callback to memoize the fetchMoreComments function
  // to prevent unnecessary re-renders
  // and to ensure it has the latest state values.
  // This is particularly useful in the context of InfiniteScroll.
  // It allows us to fetch more comments when the user scrolls down.
  ...
  if (!video) return <Spinner />; // or null or a skeleton loader
