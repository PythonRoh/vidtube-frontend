  ...
  return (
    <>
      ...
      <div className="sm:block hidden">
        <div className="text-white lg:w-56 md:w-44 w-16 sm:p-3 p-2 border-slate-600 border-r h-screen flex flex-col">
          {/* Top section (navigational links) */}
          <div className="flex flex-col gap-4 mt-5 flex-grow">
          ...
          <div className="space-y-4 w-full bg-[#0E0F0F] p-3 border-t border-slate-600 fixed bottom-0 left-0 lg:w-56 md:w-44 w-16 z-30">
            {username && (
              <div
